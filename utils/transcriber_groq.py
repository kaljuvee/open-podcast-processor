...
class AudioTranscriber:
    ...
    def transcribe_audio_chunk(self, audio_path: Path, offset_seconds: float = 0.0) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if file_size_mb > 100:
                print(f"Warning: Chunk {audio_path.name} is {file_size_mb:.1f}MB, exceeds 100MB limit")
                return None
    ...
    def transcribe_audio(self, audio_path: str) -> Optional[Dict[str, Any]]:
        ...
        # Check if chunking is needed (Groq supports up to 100MB, but we'll chunk at 20MB for reliability)
